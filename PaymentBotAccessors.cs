...
namespace PaymentBotSample
{
    ...
    /// </summary>
    public class PaymentBotAccessors
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentBotAccessors"/> class.
        ...
        public PaymentBotAccessors(ConversationState conversationState, UserState userState)
        {
